...
import { Blog, CreateBlog, createBlogSchema, UpdateBlog, updateBlogSchema } from "@/schemas";
...
export function BlogFormDialog({
  ...
  const [thumbnailPreview, setThumbnailPreview] = useState<string | null>(initialData?.thumbnail?.url || null);
  ...
  useEffect(() => {
    form.setValue("slug", generateSlug(titleValue || ""), { shouldDirty: true });
  }, [titleValue, form]);
